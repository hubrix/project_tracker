...
| `tracker.org` | tracker mode: pruning, placeholders, Team resource, `--include-done` |
...
given the same filtered input, in tracker mode. Emacs is not needed to run or extend the tests; for a
